...
export default function Background() {
  const [circleFrames, setCircleFrames] = React.useState(randomFrames(550, 200));
  const [circle2Frames, setCircle2Frames] = React.useState(randomFrames(0, 448));
  const [reactFrames, setReactFrames] = React.useState(randomFrames(1400, 300));
  const [diamondFrames, setDiamondFrames] = React.useState(randomFrames(1100, -230));
